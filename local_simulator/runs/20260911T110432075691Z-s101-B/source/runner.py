...
def run_case(seed=1, strategy="C", scenario="uniform", reception="mixed",
             ...
             opportunistic=True, compute_oracle=True, output=None):
    ...
    controller = (DynamicController(client, depth, beam_width, opportunistic)
...
def main():
    ...
    p.add_argument("--strategy", choices=["A", "B", "C"], default="C")
